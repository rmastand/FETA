...
def analyze_band_transform_kfold(dir_to_save, idd, train_samp_1, train_samp_2, test_samp_1, test_samp_2, n_features, n_epochs, batch_size, lr, patience, device, early_stop = True, visualize = True, seed = None, k_folds = 5):
    ...
    for fold, (train_ids, val_ids) in enumerate(kfold.split(X_train)):
        ...
        for epoch in tqdm(range(n_epochs)):
            ...
            for batch_index, (batch_data, batch_labels) in enumerate(train_loader):
                ...
                batch_data = X_train_fold[indices]
                batch_labels = y_train_fold[indices]
            ...
            with torch.no_grad():
                ...
                for batch_index, (batch_data, batch_labels) in enumerate(val_loader):
                    ...
                    batch_data = X_val_fold[indices]
                    batch_labels = y_val_fold[indices]
