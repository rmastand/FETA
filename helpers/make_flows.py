...
def make_coupling_flow(num_layers, num_features, num_nodes, num_blocks = 8, num_bins = 10, spline_type = "PiecewiseRationalQuadratic", perm_type = "Reverse", tail_bound = 3.5, tails = "linear"):
    ...
    def maker(input_dim, output_dim):
        return dense_net(input_dim, output_dim, layers=[num_nodes] * num_blocks, context_features=1)
